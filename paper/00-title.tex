\begin{titlepage}
	...
	\begin{center}
		\Large\textbf{\textsc{РАСЧЕТНО-ПОЯСНИТЕЛЬНАЯ ЗАПИСКА}}\\
		\Large\textbf{\textsc{на тему: }}\\
		\Large\textbf{\textsc{"методы определения позы человека"}}\\
	\end{center}
	\vspace{3.5cm}
	...
	\noindent\underline{\textnormal{~~~~Вишневская Т.И.~~~~}}
